        ...
        <div>
            ...
            <div className="p-5">
                <div className="grid grid-cols-2 border rounded-lg overflow-hidden">
                    <WeatherDetailCard title={'Humidity'} number={'67%'} icon={<TbDropletExclamation size={20} />} />
                    <WeatherDetailCard title={'Visibility'} number={'26.2 km'} icon={<MdOutlineVisibility size={20} />} />
                    <WeatherDetailCard title={'Rain'} number={'0%'} icon={<IoRainyOutline size={20} />} />
                    <WeatherDetailCard title={'Wind'} number={'5 km/h'} icon={<FiWind size={20} />} />
                </div>
            </div>
