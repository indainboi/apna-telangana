...
const next7DaysData = [
    { range: "30°C - 16°C", date: "Fri 15, Nov", percentage: "0%", type: "Mostly Clear" },
    { range: "29°C - 17°C", date: "Sat 16, Nov", percentage: "0%", type: "Thunderstorms" },
    ...
    { range: "27°C - 19°C", date: "Wed 20, Nov", percentage: "0%", type: "Partly Cloudy" },
    { range: "28°C - 19°C", date: "Thu 21, Nov", percentage: "0%", type: "Partly Cloudy" }
]

const WeatherTelugu = () => {
    return (
        <div>
            <PageHeader title={"వాతావరణం"} to={"/homepage-telugu"} />
            ...
            <div className="px-5 py-4">
                <div className="bg-blue-300 rounded-lg flex flex-col overflow-hidden">
                    <div className="flex flex-col gap-1 px-5 py-5 text-white">
                        ...
                        <p className='text-sm'>మేఘావృతం</p>
                    </div>
                </div>
            </div>
            ...
            <div className="p-5">
                <div className="grid grid-cols-2 border rounded-lg overflow-hidden">
                    <WeatherDetailCard title={'తేమ'} number={'67%'} icon={<TbDropletExclamation size={20} />} />
                    <WeatherDetailCard title={'దృశ్యత'} number={'26.2 km'} icon={<MdOutlineVisibility size={20} />} />
                    <WeatherDetailCard title={'వర్షం'} number={'0%'} icon={<IoRainyOutline size={20} />} />
                    <WeatherDetailCard title={'గాలి'} number={'5 km/h'} icon={<FiWind size={20} />} />
                </div>
            </div>
            ...
            {/* Next 7 Days */}
            <div className="px-5 py-4">
                <h4 className="mb-3">వచ్చే 7 రోజులు</h4>
