...
const menus = [
  { name: "Crop Advisory", url: "/images/crop_advisory.png", to: "/crop-advisory" },
  { name: "Community", url: "/images/community.png", to: "/community" },
  { name: "Market Place", url: "/images/market_place.png", to: "/market-place" },
  { name: "Apna Telangana Social", url: "/images/social.png", to: "/apna-telangana" }
]
    ...
    <div>
      ...
      <div className='px-5 py-4'>
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='py-3 bg-[#049E6A] rounded-lg text-center text-white text-lg'>Support</div>
        </div>
      </div>
    </div>
  )
