...
const SocialFeedPosts = [
  {
    ...
    caption:
      "Visited the agricultural training centre in Hyderabad, where modern farming techniques are being taught to the next generation of farmers",
    like: "2137",
    comments: "675",
    shares: "307",
  },
  {
    ...
    caption:
      "Introducing our solar-powered irrigation system designed specifically for the unique needs of Telangana’s farmers. Let’s",
    like: "290",
    comments: "5",
    shares: "11",
  },
  {
    ...
    caption:
      "Just tried the new organic pest control method I learned at the workshop last week. Not only is it effective, but it's also safe",
    like: "542",
    comments: "239",
    shares: "99",
  },
  {
    ...
    caption:
      "Announcing the launch of “Smart Farming Initiative” across Telangana under the Apna Telangana movement.",
    like: "940",
    comments: "487",
    shares: "220",
  },
  {
    ...
    day: "4d",
    caption:
      "Delighted to share that our NGO is looking to train 500 farmers in organic farming practices in Siddipet District as our contribution to Apna Telangana movement",
    like: "416",
    comments: "70",
    shares: "51",
  },
  {
    ...
    caption:
      "Today, I had the privilege of visiting the farm of Mr. Ravi Kumar in Karimnagar District, a progressive farmer who has been actively sharing",
    like: "864",
    comments: "366",
    shares: "108",
  },
  {
    ...
    caption:
      "Facing some issues with my paddy crop due to unexpected rains. Any fellow farmers have tips on drainage solutions? Appreciate any",
    like: "583",
    comments: "45",
    shares: "89",
  },
  {
    ...
    caption:
      "Our team conducted a free training session on modern irrigation techiques in Siddipet today #ApnaTelanganaAgriculture",
    like: "542",
    comments: "67",
    shares: "29",
  },
  {
    ...
    caption:
      "Proud to announce that Telangana Agricultural University has developed a new high-yielding variety of millet suited for Telangana's",
    like: "287",
    comments: "15",
    shares: "26",
  },
  {
    ...
    caption:
      "Harvested my first batch of strawberries today! Switching to fruit cultivation was a big decision, but seeing these results makes it",
    like: "731",
    comments: "310",
    shares: "170",
  },
  {
    ...
    day: "5d",
    caption:
      "Hosting a live Q&A session this Saturday on pest management without heavy reliance on chemicals. Bring your questions and let’s",
    like: "675",
    comments: "181",
    shares: "129",
  },
...
const ApnaTelangana = () => {
  return (
    <div>
      <ApnaTelanganaHeader title={"Apna Telangana"} to={"/homepage"} />
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                ...
                <MdVerified
                  className={position === "NA" ? "hidden" : ""}
                  color={verifiedColor(position)}
                />
              </div>
