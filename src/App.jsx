    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/market-place/farmer-calender" element={<FarmerCalender />} />
          <Route path="/market-place/trader-calender" element={<TraderCalender />} />
          <Route path="/community/micro-irrigation" element={<CommunityPage />} />
          <Route path="/community/micro-irrigation/registered-users1" element={<RegisteredUsers1 />} />
          <Route path="/community/micro-irrigation/registered-users2" element={<RegisteredUsers2 />} />
          <Route path="/community/micro-irrigation/ravi-kumar" element={<RaviKumar />} />
          <Route path="/community/micro-irrigation/nizambad" element={<Nizambad />} />
          ...
          <Route path="/crop-advisory-telugu" element={<CropAdvisoryTelugu />} />
          <Route path="/community-telugu" element={<CommunityTelugu />} />
          <Route path="/community/micro-irrigation-telugu" element={<CommunityPageTelugu />} />
          <Route path="/community/micro-irrigation/registered-users1-telugu" element={<RegisteredUsers1Telugu />} />
          <Route path="/community/micro-irrigation/registered-users2-telugu" element={<RegisteredUsers2Telugu />} />
